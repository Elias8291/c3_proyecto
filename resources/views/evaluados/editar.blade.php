                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input name="primer_apellido"
                                    value="{{ old('primer_apellido', $evaluado->primer_apellido) }}"
                                    class="form-control @error('primer_apellido') form-error @enderror" type="text"
                                    required pattern="^[a-zA-ZÀ-ÿ\u00f1\u00d1\s]+$"
                                    title="Solo se permiten letras y espacios." maxlength="50">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input name="fecha_nacimiento"
                                    value="{{ old('fecha_nacimiento', $evaluado->fecha_nacimiento ? $evaluado->fecha_nacimiento->format('Y-m-d') : '') }}"
                                    class="form-control @error('fecha_nacimiento') form-error @enderror" type="date"
                                    required id="fecha_nacimiento">
                                ...
                                <div>
                                    <label class="form-check-inline">
                                        <input type="radio" name="sexo" value="M"
                                            class="form-check-input @error('sexo') form-error @enderror" {{ old('sexo',
                            ...
                            <div class="form-group mb-4">
                                ...
                                <select name="estado_nacimiento"
                                    ...
                                    <option value="BS" {{ old('estado_nacimiento')=='BS' ? 'selected' : '' }}>Baja
                                        California
                                        Sur (BS)</option>
                                    <option value="CC" {{ old('estado_nacimiento')=='CC' ? 'selected' : '' }}>Campeche
                                        (CC)
                                    </option>
                                    <option value="CL" {{ old('estado_nacimiento')=='CL' ? 'selected' : '' }}>Coahuila
                                        (CL)
                                    </option>
                                    <option value="CM" {{ old('estado_nacimiento')=='CM' ? 'selected' : '' }}>Colima
                                        (CM)
                                    </option>
                                    <option value="CS" {{ old('estado_nacimiento')=='CS' ? 'selected' : '' }}>Chiapas
                                        (CS)
                                    </option>
                                    ...
                                    <option value="DF" {{ old('estado_nacimiento')=='DF' ? 'selected' : '' }}>Ciudad de
                                        México
                                        (DF)</option>
                                    <option value="DG" {{ old('estado_nacimiento')=='DG' ? 'selected' : '' }}>Durango
                                        (DG)
                                    </option>
                                    <option value="GT" {{ old('estado_nacimiento')=='GT' ? 'selected' : '' }}>Guanajuato
                                        (GT)
                                    </option>
                                    <option value="GR" {{ old('estado_nacimiento')=='GR' ? 'selected' : '' }}>Guerrero
                                        (GR)
                                    </option>
                                    <option value="HG" {{ old('estado_nacimiento')=='HG' ? 'selected' : '' }}>Hidalgo
                                        (HG)
                                    </option>
                                    <option value="JC" {{ old('estado_nacimiento')=='JC' ? 'selected' : '' }}>Jalisco
                                        (JC)
                                    </option>
                                    ...
                                    <option value="MS" {{ old('estado_nacimiento')=='MS' ? 'selected' : '' }}>Morelos
                                        (MS)
                                    </option>
                                    <option value="NT" {{ old('estado_nacimiento')=='NT' ? 'selected' : '' }}>Nayarit
                                        (NT)
                                    </option>
                                    <option value="NL" {{ old('estado_nacimiento')=='NL' ? 'selected' : '' }}>Nuevo León
                                        (NL)
                                    </option>
                                    <option value="OC" {{ old('estado_nacimiento')=='OC' ? 'selected' : '' }}>Oaxaca
                                        (OC)
                                    </option>
                                    <option value="PL" {{ old('estado_nacimiento')=='PL' ? 'selected' : '' }}>Puebla
                                        (PL)
                                    </option>
                                    <option value="QT" {{ old('estado_nacimiento')=='QT' ? 'selected' : '' }}>Querétaro
                                        (QT)
                                    </option>
                                    <option value="QR" {{ old('estado_nacimiento')=='QR' ? 'selected' : '' }}>Quintana
                                        Roo (QR)
                                    </option>
                                    <option value="SP" {{ old('estado_nacimiento')=='SP' ? 'selected' : '' }}>San Luis
                                        Potosí
                                        (SP)</option>
                                    <option value="SL" {{ old('estado_nacimiento')=='SL' ? 'selected' : '' }}>Sinaloa
                                        (SL)
                                    </option>
                                    <option value="SR" {{ old('estado_nacimiento')=='SR' ? 'selected' : '' }}>Sonora
                                        (SR)
                                    </option>
                                    <option value="TC" {{ old('estado_nacimiento')=='TC' ? 'selected' : '' }}>Tabasco
                                        (TC)
                                    </option>
                                    ...
                                    <option value="YN" {{ old('estado_nacimiento')=='YN' ? 'selected' : '' }}>Yucatán
                                        (YN)
                                    </option>
                                    <option value="ZS" {{ old('estado_nacimiento')=='ZS' ? 'selected' : '' }}>Zacatecas
                                        (ZS)
                                    </option>
                                    <option value="NE" {{ old('estado_nacimiento')=='NE' ? 'selected' : '' }}>Nacido en
                                        el
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group mb-4">
                                <label class="form-label" for="fecha_apertura">Fecha de Evaluación <span
                                        style="color: #e53e3e;">*</span></label>
                                <input name="fecha_apertura"
                                    value="{{ old('fecha_apertura', $evaluado->fecha_apertura ? $evaluado->fecha_apertura->format('Y-m-d') : '') }}"
                                    class="form-control @error('fecha_apertura') form-error @enderror" type="date"
                                    required id="fecha_apertura">
                                ...
                                <div>
                                    <label class="form-check-inline">
                                        <input type="radio" name="resultado_evaluacion" value="1"
                                            ...
                                            {{ old('resultado_evaluacion', $evaluado->resultado_evaluacion) == '1' ?
                                        'checked' : ''
                                        }} required> Aprobado
                                    </label>
                                    <label class="form-check-inline">
                                        <input type="radio" name="resultado_evaluacion" value="0"
                                            class="form-check-input @error('resultado_evaluacion') form-error @enderror"
                                            {{ old('resultado_evaluacion', $evaluado->resultado_evaluacion) == '0' ?
                                        'checked' : ''
