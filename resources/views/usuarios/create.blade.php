...
@section('content')
    ...
    <div class="container">
        ...
        <form action="{{ route('usuarios.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <div class="password-requirements" style="display: none;">
                        ...
                        <div class="strength-text">Fortaleza de la contraseña: <span id="strength-value">Débil</span>
                        </div>
                    </div>
                </div>
            ...
            <button type="submit" class="btn btn-submit" id="submitBtn" disabled>Crear Usuario</button>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function validateForm() {
                ...
                const isApellidoPaternoValid = apellidoPaternoInput.value.trim().length > 0;
                const isEmailValid = Object.values(emailRequirements).every(fn => fn(emailInput.value));
                const isPasswordValid = Object.values(requirements).every(fn => fn(passwordInput.value));
                const isPasswordMatch = passwordInput.value === confirmPasswordInput.value;
                const isPhoneValid = Object.values(phoneRequirements).every(fn => fn(phoneInput.value));

                // Botón de submit
                const submitBtn = document.getElementById('submitBtn');

                if (isNameValid && isApellidoPaternoValid && isEmailValid && isPasswordValid && isPasswordMatch &&
                    isPhoneValid) {
            ...
            apellidoPaternoInput.addEventListener('input', validateForm);
            ...
            // Modificar el evento del input de teléfono
            phoneInput.addEventListener('input', function() {
